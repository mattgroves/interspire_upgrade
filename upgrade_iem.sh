...
IEM_URL='https://www2.fpn-process.com'  # The URL of your IEM installation
IEM_WEBROOT='/home/fpnprocess/public_html/www2.fpn-process.com' # Your installation directory and web root
BACKUP_DIR='/root/iem_backups'  # A new directory for working backups
IEM_USER='fpnprocess'                   # User that the web server or web user runs as
IEM_GROUP='fpnprocess'                  # Group that the web server or web user runs as
